...
interpolazioni dei dataset separati: la compatibilità con il valore di aspettazione risulta essere $Z=1.4$




%\noindent Osservando il grafico dei residui in Figura \ref{i:opamp_all_proj} si nota un andamento leggermente anomalo,
%quasi parabolico con concavità rivolta verso il basso
