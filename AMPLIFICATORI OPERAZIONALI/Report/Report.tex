...
dei residui dove la scala di rappresentazione è la stessa per entrambi gli assi.}.
\begin{figure}[H]
	\centering
...
Dallo studio dell'amplificazione del circuito, rappresentato in \autoref{i:opamp_circuit}, è emersa poi una sistematica
...
una stima $f_{\text{t}}=19.8 \pm 0.8\,\si{\kHz}$ in ottimo accordo con le aspettative. Si prende dunque quest'ultima
