...
due, infatti, si trova $\langle m\rangle_{\text{max, min}}=10.09 \pm 0.07$ e risulta avere una compatibilità
...
residui attorno allo zero) che si ritiene invece, in questa occasione, determinante: il campione di
misure picco picco (Figura \ref{i:opamp_pp}) suggerisce una soddisfacente distribuzione lineare dei dati. 

%confronto delle stime di G
