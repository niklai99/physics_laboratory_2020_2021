...
%$1\,\si{n\farad}$) in serie alla resistenza $R_{1}$, tra essa e l'amplificatore operazionale. Si imposta inizialmente
%il generatore in 
%
...
%\end{wrapfigure}
%
%\noindent modo da erogare un'onda triangolare di ampiezza $1\,\si{V}$ e frequenza $1\,\si{k\Hz}$, al fine di verificare
%il comportamento derivatore del circuito. Successivamente si ripristina la forma sinusoidale di ampiezza $1\,\si{\volt}$
%picco picco (che verrà mantenuta costante) e frequenza variabile tra $100\,\si{\Hz}$ e $1\,\si{\MHz}$.\\
%
%\noindent Si vuole ora porre particolare attenzione al circuito in \autoref{i:diff_circuit}: nel dominio delle frequenze
...
%un circuito passa alto passivo. A basse frequenze dunque il circuito ci si aspetta si comporti come un derivatore,
