...
saturazione del segnale in uscita segue le previsioni esposte in \autoref{s:spice}. Spostando l'attenzione verso il
grafico dei residui, si può notare chiaramente l'effetto della saturazione del segnale: le misure acquisite in tale
condizione risultano essere outliers rispetto al trend lineare dei dati rimanenti (zona centra), i quali residui si
distribuiscono ragionevolmente attorno allo zero. Quanto spazio ho ancora?
