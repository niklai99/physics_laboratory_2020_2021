...
attraverso grandezze picco picco, sia considerando la media pesata dei risultati ottenuti dai campioni separati),
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{../Plots/Report_Plots/opamp_comp_BIG.png}
	...
	\label{i:opamp_comp}
\end{figure}
\noindent la stima dell'amplificazione del circuito risulta essere compatibile con le aspettative preliminari. Si assume in ogni
caso che l'errore su \textit{G} sia sottostimato a causa della correlazione tra errori di scala dell'oscilloscopio: si
