...
\subsection{Simulazione Spice Preliminare}
...
per conservazione dell'energia: ci si aspetta allora di trovare una situazione di saturazione del segnale in uscita. 
...
all'operazionale. Inoltre, come anticipato in Sezione \ref{s:guadagno}, si può osservare il comportamento invertente
