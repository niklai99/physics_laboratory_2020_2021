...
Si inizia assemblando il seguente circuito, utilizzando le resistenze $R_f$, $R_1$, $R_3$ e l'amplificatore operazionale che, essendo un componente
circuitale attivo, viene alimentato da sfruttando il generatore di tensione continua con $V_{cc}=+15\,\si{\volt}$ e $V_{ee}=-15\,\si{\volt}$.
