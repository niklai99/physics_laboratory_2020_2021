...
in modalità "50 Ohm". Si sceglie di effettuare la simulazione solamente con un segnale in ingresso di ampiezza picco picco
$Vpp_{\text{gen}}=2\,\si{\volt }$.

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{../Plots/Report_Plots/opamp_spice_1V.png}
	\caption{Simulazione Spice della risposta del circuito ad una tensione sinusoidale di frequenza
	$f_{\text{gen}}=1\,\si{k\hertz}$ e ampiezza picco picco $Vpp_{\text{gen}}=2\,\si{\volt }$}
