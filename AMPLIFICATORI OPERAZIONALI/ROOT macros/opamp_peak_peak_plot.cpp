...
/*---caso dati con errori---*/
    ...
    NSP::c1->SaveAs("../Plots/opamp_peak_plot.png");
    NSP::c2->SaveAs("../Plots/opamp_peak_res.png");
}
...
void NSP::settings_fit(TGraph* graph) {
    ...
    //titolo e assi
    graph-> SetTitle("OpAmp Picco Picco; Vpp_{in} (V); Vpp_{out} (V)");
...
void NSP::settings_res(TGraph* graph) {
    ...
    //titolo e assi 
    graph-> SetTitle("Residui; Vpp_{in} (V); fit - Vpp_{out} (V)");
