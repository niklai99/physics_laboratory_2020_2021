...
\begin{table*}[t]
    ...
    \centering
    \begin{tabular}{x{1.3cm}x{1.5cm}x{1.1cm}x{1.3cm}x{1.5cm}x{1.1cm}|x{1.5cm}x{1.1cm}x{1.5cm}x{1.1cm}}
    ...
    $7.8 \pm 0.2$ & $61 \pm 2$ & $12 / 2$ & $7.9 \pm 0.2$ & $13.8 \pm 0.4$ & $1.5 / 2$ & $60.8 \pm 0.8$ & $12 /3 $ &
    $13.8 \pm 0.4$ & $1.5 / 3 $\tn 
...
\begin{table}[t]
    \begin{center}
        \begin{tabular}{x{1.5cm} x{1.8cm} | x{1.5cm} x{1.8cm}}
            \toprule[0.5px]
            \toprule[0.1px]
            \multicolumn{2}{c}{\textbf{Ag}} & \multicolumn{2}{c}{\textbf{Cu}} \tn
            \midrule[0.1px]
