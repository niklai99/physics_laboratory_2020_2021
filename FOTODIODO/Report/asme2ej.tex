...
radiazione incidente sull'assorbitore mentre $x$ è lo spessore attraversato. In particolare, si vuole fornire una stima
...
fit delle misure di rate al variare dello spessore dell'assorbitore. È opportuno sottolineare che, a seconda del
...
confrontare con i valori teorici, assunti privi di errore : $\mu_{\rho}^{\text{th}}$(Ag) = 5.7660
$\si{\centi\metre^2\gram^{-1}}$ e $\mu_{\rho}^{\text{th}}$(Cu) = 1.593 $\si{\centi\metre^2\gram^{-1}}$. Si ottengono:
