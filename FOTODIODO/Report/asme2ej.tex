...
fedelmente l'andamento della probabilità di emissione di un fotone con tale energia, ad eccezione del picco a
$17.8\,\si{\kilo\electronvolt}$ che risulta essere leggermente più alto: la causa di questa lieve discrepanza è dovuta
ai numerosi contributi trascurati in quel range di energia. Il parametro di rumore $\eta$, invece, risulta essere
decisamente trascurabile rispetto al contributo di risoluzione intrinseca 
