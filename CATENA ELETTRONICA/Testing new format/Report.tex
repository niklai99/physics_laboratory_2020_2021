...
\begin{wraptable}{L}{0.5\textwidth} 
	...
	\toprule[0.5px]\toprule[0.1px] 
	   ...
	   \bottomrule[0.5px]      
   \end{tabular} 
   \caption{\small Misure dirette delle componenti circuitali.} \label{t:catena_direct_measures}
\end{wraptable}    

di guadagno $G = 1 + \frac{R_{2\text{a}}}{R_{1\text{a}}} = 9.254 \pm 0.004$. Impostando il generatore come in
