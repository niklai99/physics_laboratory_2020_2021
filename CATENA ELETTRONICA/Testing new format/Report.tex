...
in precedenza. Si vuole ora confrontare le misure sperimentali acquisite con l'oscilloscopio ed i dati acquisiti con la
scheda Arduino. In \autoref{t:shaper_vout} si riportano quindi le misure del massimo di tensione, il tempo in cui tale
massimo viene assunto e la tensione di \textit{undershoot}. 
...
invertente, ovvero l'ultimo stadio della catena rappresentato in \autoref{i:circuito}. Lo scopo di questo terzo ed ultimo
