...
tensione massimo corrispondente a $V_{\text{max}}^{\text{pre}} = 0.388 \pm 0.017 \,\si{\volt}$ (misurando l'ampiezza del
...
di tensione pari a $V^{\text{sper}}_{\text{out}} = 0.392 \pm 0.007 \,\si{\volt}$ e un tempo caratteristico di circa
$\tau^{\text{sper}} \approx 0.158 \,\si{\us}$, perfettamente in linea con le aspettative. Si vuole, tuttavia,
