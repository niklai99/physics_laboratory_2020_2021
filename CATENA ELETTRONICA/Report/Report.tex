...
\end{figure}
\noindent Si vuole ora confrontare le misure sperimentali acquisite con l'oscilloscopio e i dati acquisiti con la scheda
Arduino. 

\begin{table}[H]
	\small
	\centering
	\begin{tabular}{x{2.2cm} x{2.3cm} | x{2.2cm} x{1.8cm} | x{2.5cm} x{2.3cm}} \toprule[0.5px]\toprule[0.1px]	
		\multicolumn{6}{c}{Shaper - Segnale in uscita senza $R_{\text{pz}}$}\tn
		\midrule[0.1px]
		...
		$ 123 \pm 2 $&$ 124 \pm 19 $&$ 17 \pm 1 $&$ \sim 16.81 $&$ -19.7 \pm 1.1 $&$ -20 \pm  17 $\tn
		$ $&$ $&$ $&$ $&$ $&$ $\tn

		\bottomrule[0.5px]		
	\end{tabular}
	\caption{\footnotesize Confronto segnale in uscita dallo shaper.}
	\label{t:shaper_vout}
\end{table}	
