...
\section{Shaper CR-RC}\label{s:shaper} Il secondo stadio della catena (\textit{shaper}) si utilizza per modificare la
...
utilizzando nell'esperienza per simulare l'evento rivelato dal detector. 
