...
%
%
%	DEVO DIRE CHE GLI ERRORI RELATIVI SU X E Y SONO DELLO STESSO ODG QUINDI NON POSSO TRASCURARE L'ERRORE MA NON LO
%	CONSIDERO NEL FIT QUINDI LO SCORPORO E LO AGGIUNGO DOPO
%
%
\begin{figure}[H]
	\centering
...
\begin{align}
	C_{\text{f}}^{\text{fit}}& = 0.232 \pm 0.005 \,\si{n\farad} 
	& 
