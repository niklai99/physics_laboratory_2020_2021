...
tempo caratteristico $\tau^{\text{th}} = 0.161 \pm 0.006 \,\si{\ms}$. Sperimentalmente, si misura un valore massimo
...
compatibile con la stima teorica $\tau^{\text{th}} = 0.161 \pm 0.006 \,\si{\ms}$ ($\lambda = 1.4$). Dal grafico di
denstra, invece, si nota chiaramente una sovrastima dell'errore: 
